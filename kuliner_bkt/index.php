...
<html lang="en">
  <head>
    ...
    <input type="hidden" id="lokasi" required>
...
var server = "http://localhost/Souvenir_Postgre/kuliner_bkt/";
var map;
var markersDua = [];
var koordinat = 'null'
var infoposisi = [];
var markerposisi = [];
var centerLokasi=document.getElementById('lokasi').valueS;
var markerposisi = [];
var centerBaru;
...
function addMarker(location)
{
  ...
  centerLokasi2 = new google.maps.LatLng(koordinat.lat, koordinat.lng);
  ...
  document.getElementById('lokasi').value=centerLokasi2;
    centerLokasi=document.getElementById('lokasi').value;
