    ...
    { 
      ...
      else
      {
        ...
        { 
          ...
          map.setCenter(centerBaru);
          if(tabel == 'sou'){
           $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success  fa fa-info' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
            
          } else {
           $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title='Show Information' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' title='Show Route' onclick='souangkot(\""+id+"\")'></a></td></tr>");
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          console.log(jenis);
          if (jenis == 'sou') {
            $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button' class='btn btn-success fa fa-info' title='Show Information' onclick='detsou(\""+id_tempat_kuliner+"\");detsousou(\""+id_tempat_kuliner+"\")'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id_tempat_kuliner+"\")'></a></td></tr>");
          } else {
            $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button'class='btn btn-success fa fa-info' title='Show Information'  onclick='detsou(\""+id_tempat_kuliner+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id_tempat_kuliner+"\")'></a></td></tr>");
          }
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          $('#hasilcari').append("<tr><td>"+nama+"</td><td><a role='button' class='btn btn-success fa fa-info' title='Show Information' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button'  title='Show Route' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
      }
    }); 
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          $('#hasilcari').append("<tr><td>"+nama+"</td><td><a role='button' title='Show Information' class='btn btn-success fa fa-info' onclick='detik(\""+id+"\");detikik(\""+id+"\");'></a></td><td><a role='button' title='Show Route' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
      }
    }); 
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          clickMarker(centerBaru, id);
          console.log(id_souvenir_type);
          $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' title='Show Information' class='btn btn-success fa fa-info' onclick='detsou(\""+id+"\");detsousou(\""+id+"\")'></a></td><td><a role='button' title='Show Route' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
      }
    }); 
      ...
      { 
        ...
        {   
          ...
          if (tabel == 'sou') {
            ...
            $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' title='Show Information' class='btn btn-success fa fa-info' onclick='detsou(\""+id+"\");'></a></td><td><a role='button' title='Show Route' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
          }
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          console.log(id_status);
          if (tabel == 'sou') {
            $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title='Show Information'  onclick='detsou(\""+id+"\");detsousou(\""+id+"\")'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
          } else {
            $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title='Show Information'  onclick='detsou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
          }
          // $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");detsouxx(\""+id+"\");'>Show</a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
        ...
        if(rows==null)
          ...
          for (var i in rows) 
              ...
              ({
                ...
                map.setZoom(16);
                clickMarker(centerBaru, id);
                $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
              }
      ...
      if(rows==null && arrayLay2.length != 0)
        ...
        for (var i in rows) 
            ...
            ({
              ...
              map.setZoom(16);
              clickMarker(centerBaru, id);
              $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detik(\""+id+"\");detikik(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
            }
            // jml = jml + rows.length;
            // alert('hai')
    ...
    { 
      ...
      else
      {
        ...
        { 
          ...
          map.setZoom(13);
           clickMarker(centerBaru, id); 
           $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detik(\""+id+"\");detikik(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
        }
      } 
      // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
    }
    ...
    { 
      ...
      {   
       ...
       // map.setCenter(koordinat);
        ...
        // console.log(rad);
        clickMarker(centerBaru, id);
        $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detsou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");    
       }
       // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
    }
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a class="logo" ><p><img src="">&nbsp<b>S</b>ouvenir <img src="image/kripik-bg.png" width="60" height="44"> </p></a>
            <!--logo end-->
              ...
              <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group"> <br>
                          ...
                          <select class="form-control select2" style="width: 100%; height: 10;" id="carikecamatankul">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group"> <br>
                          <!-- <label style="color: white;">Sub District</label> -->
                          <select class="form-control select2" style="width: 100%; height: 10;" id="caritipe">
                            <option value="">-Choose-</option>
                            <?php
                              include("connect.php"); 
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group"> <br>
                          <!-- <label style="color: white;">Sub District</label> -->
                          <select class="form-control select2" style="width: 100%; height: 10;" id="caritipe2">
                            <option value="">-Choose-</option>
                            <?php
                              include("connect.php"); 
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group"> <br>
                          <!-- <label style="color: white;">Sub District</label> -->
                          <select class="form-control select2" style="width: 100%; height: 10;" id="caristatus">
                            <option value="">-Choose-</option>
                            <?php
                              include("connect.php"); 
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group"> <br>
                          <!-- <label style="color: white;">Sub District</label> -->
                          <select class="form-control select2" style="width: 100%; height: 10;" id="cp">
                            <option value="">-Choose-</option>
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group"> <br>
                          <!-- <label style="color: white;">Sub District</label> -->
                          <select class="form-control select2" style="width: 100%; height: 10;" id="rating">
                            <option value="">-Choose-</option>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                       <div class=" form-group"> <br>
                          <select class="form-control select2" style="width: 100%; height: 10;" id="cariprice">
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                       <div class=" form-group"> <br>
                          <select class="form-control select2" style="width: 100%; height: 10;" id="cariprice2">
                            <option name="harga" value="">-Choose-</option>
                    ...
                    <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <div class=" form-group" style="color: white;"> <br>
                          ...
                          <!-- <label style="color: white;">Sub District</label> -->
                          <select class="form-control select2" style="width: 100%; height: 10;" id="caristatus_rad">
                            <option value="">-Choose-</option>
                            <?php
                              include("connect.php"); 
                              $caristatus=mysqli_query($conn,"select * from status order by status ASC");
                  ...
                  <ul class="sub">
                    <li class="sub-menu">
                      <a href="google/HelloAnalytics.php" >
                    ...
                    <li class="sub-menu">
                  <a href="google/getdata.php" >
                    <i class="fa fa-cubes"></i>
                    <span>Organic User</span>
                  </a>
                  </li>
                  <li class="sub-menu">
                      <a href="google/HelloAnalytics2.php" >
                        <i class="fa fa-cubes"></i>
                ...
                <label style="color: black">Google Map With Location List :</label>
                   <button type="button" onclick="posisisekarang()" class="btn btn-default " data-toggle="tooltip" id="posisinow" title="Posisi Saya" 
                    style="margin: 15px" style="margin-right: 7px;" ><i class="fa fa-location-arrow" > </i>
                       ...
                       <label id="tombol">
                       <button type="button" onclick="legenda()" id="showlegenda" class="btn btn-default" data-toggle="tooltip" title="Legenda" style="margin-right: 7px;"><i class="fa fa-eye"></i>
                       </button>
                       </label>
                  </header>
                <!-- First Action -->
           ...
           <div id="view_kanan_table" class="col-md-4 col-sm-4 mb" style="margin-top:0px; display:block;">
                        <div class="white-panel pns" style="height:510px">
                           <div class="white-header" style="height:40px;margin:20px;background:white;color:black">
                             <h5 class="btn btn-compose" id="judul_table">Popular Souvenir</h5>
                           </div>
                           <div class="row">
                           ...
                           <div style="height:410px; overflow-y: scroll; margin:20px;">
                              <div class="html5gallery" style="max-height:700px; overflow:auto; display:block;" data-skin="horizontal" data-width="280" data-resizemode="fit">
                                <a href='../_foto/2222.jpg'><img src='../_foto/2222.jpg'></a>
                              <a href='../_foto/SO0111.jpg'><img src='../_foto/SO0111.jpg'></a>
                              <a href='../_foto/1.kap1.JPG'><img src='../_foto/1.kap1.JPG"'></a>
                              <a href='../_foto/1.don1.jpg'><img src='../_foto/1.don1.jpg'></a>
                              <a href='../_foto/id1.jpg'><img src='../_foto/id1.jpg'></a>
                              <?php
