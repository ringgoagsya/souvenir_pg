      ...
      { 
        ...
        {   
          ...
          if (jenis == 'sou') {
            ...
            $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button'class='btn btn-success fa fa-info' title='Show Information'  onclick='detsou(\""+id_tempat_kuliner+"\");detsousou(\""+id_tempat_kuliner+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id_tempat_kuliner+"\")'></a></td></tr>");
          }
      ...
      { 
        ...
        {   
          ...
          if (tabel == 'sou') {
            ...
            $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' title='Show Information' class='btn btn-success fa fa-info' onclick='detsouxx(\""+id+"\");'></a></td><td><a role='button' title='Show Route' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
          }
      ...
      { 
        ...
        {   
          ...
          if (tabel == 'sou') {
            ...
            $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title='Show Information'  onclick='detsouxx(\""+id+"\");'></a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
          }
          // $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");detsouxx(\""+id+"\");'>Show</a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a class="logo" ><font face="Courier New">WebGis Souvenir (22 Ringgo Sahara AL 1811522023)</font> <img src=""></a>
            <!--logo end-->
    ...
    .l {
                ...
                <label style="color: black">Google Map With Location List :</label>
                   <button type="button" onclick="posisisekarang()" class="btn btn-success " data-toggle="tooltip" id="posisinow" title="Posisi Saya" 
                    style="margin: 15px" style="margin-right: 7px;" ><i class="fa fa-location-arrow" > </i>
                       ...
                       <label id="tombol">
                       <button type="button" onclick="legenda()" id="showlegenda" class="btn btn-success" data-toggle="tooltip" title="Legenda" style="margin-right: 5px;"><i class="fa fa-eye"></i>
                       </button>
                       </label>
                  </header>
                <!-- First Action -->
      ...
      *********************************************************************************************************************************************************** -->                  
           <div id="view_kanan_table" style="margin-top:0px; display:block;">
                  ...
                  <div class="row">                   
                      <div class="col-md-11 col-sm-12 mb">
                        <div class="white-panel pns" style="height: 510px">
                          ...
                          <div style="height:310px; overflow-y: scroll; margin:20px;">
                            <div class="slideshow-container">
                               <div class="mySlides">
                                <div class="numbertext">1 / 4</div>
                                <a href="" onclick="gallery('SO031')"><img style="width:100%" src='../_foto/2222.jpg'></a>
                                <div class="text">Tangkelek Bukittinggi</div>
                              </div>
                              <div class="mySlides">
                                <div class="numbertext">2 / 4</div>
                                <a href="" onclick="gallery('SO011')"><img style="width:100%" src="../_foto/SO0111.jpg"></a>
                                <div class="text">Sanjai Mintuo</div>                              
                              </div>
                              <div class="mySlides">
                                <div class="numbertext">3 / 4</div>
                                <a href="" onclick="gallery('SO030')"><img style="width:100%" src="../_foto/1.kap1.JPG"></a>
                                <div class="text" style="color:#000959">Kapuyuak Clothing</div>                               
                              </div>
                              <div class="mySlides">
                                <div class="numbertext">4 / 4</div>
                                <a href="" onclick="gallery('SO025')"><img style="width:100%" src="../_foto/1.don1.jpg"></a>
                                <div class="text">Donat Madu</div>                                
                              </div>
                            ...
                            <div class="slideshow-container">
                              <div class="column">
                                <img class="demo cursor" src="../_foto/2222.jpg" style="width:100%" onclick="currentSlide(1)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/SO0111.jpg" style="width:100%" onclick="currentSlide(2)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/1.kap1.jpg" style="width:100%" onclick="currentSlide(3)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/1.don1.jpg" style="width:100%" onclick="currentSlide(4)">
                              </div>
