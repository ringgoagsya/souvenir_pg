...
$homepage = file_get_contents("http://localhost:8080/souvenir_bkt/mailtemplate.php?token=$token&user=$username");
  ...
  if($cek)
  {
    ...
    $mail->setFrom("anandamardhatillah23@gmail.com", "SISTEM INFORMASI BKT Tourism");
    $mail->Username = "anandamardhatillah23@gmail.com";
    $mail->Password = "nan_da23072014";
